...
LONGITUD_MAQUINA = 1200  # mm (Distancia total de proceso)

# Posiciones de los grupos (mm desde el sensor de entrada)
POS_FRESADOR = 150
POS_ALIMENTADOR = 300  # Referencia para alimentador y guillotina
POS_RETESTADOR = 600
POS_REFILADOR = 900
...
PIN_SENSOR_ENTRADA = 4       # Pulsador 1
PIN_PARO_ENTRADA = 27        # Dip switch (NC)
PIN_PARO_SALIDA = 22         # Dip switch (NC)

# 2. CONEXIÓN SPI (MCP3008 - Temperatura)
SPI_CLK = 11
SPI_MISO = 9
SPI_MOSI = 10
SPI_CS = 8

# 3. SALIDAS (Actuadores y Motores)
PIN_CADENA = 5               # Contactor Cadena Avance
PIN_MOTOR_FRESADOR = 6       # Contactor Motores Fresado
PIN_EV_FRESA_1 = 12          # EV Fresa 1 (Entrada)
PIN_EV_FRESA_2 = 16          # EV Fresa 2 (Salida)
PIN_SSR_ENCOLADOR = 18       # SSR Calefacción (PWM)
